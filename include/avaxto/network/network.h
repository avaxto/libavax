...
#ifndef AVAXTO_NETWORK
#define AVAXTO_NETWORK


#include "avaxto/network/connection.h"
...
#define AVAX_INITIAL_CONNECTION_POOL_SIZE 16

void avax_start_network();
void avax_network_listen();

struct avax_network {
    struct avax_peer_connection *connections;
};
