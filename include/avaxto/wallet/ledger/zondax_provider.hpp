...
class zondax_provider : public provider {
public:
    static std::shared_ptr<zondax_provider> instance();
    
    provider_type get_type() const override { return provider_type::zondax; }
...
private:
    zondax_provider() = default;
    static std::shared_ptr<zondax_provider> instance_;
};
