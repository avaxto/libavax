...
void keccak256::get_hash(const uint8_t msg[], size_t len, uint8_t hashResult[HASH_LEN]) {
...
bc::data_chunk keccak256::get_hash(const bc::data_chunk& data) {
	bc::data_chunk result(HASH_LEN);
